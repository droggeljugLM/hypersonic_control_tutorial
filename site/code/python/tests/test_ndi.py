...
class NdiTests(unittest.TestCase):
    def test_ndi_command_respects_limits(self):
    ...
    def test_ndi_short_simulation_runs(self):
        _, metrics = run("ndi", duration=1.0, dt=0.05)
